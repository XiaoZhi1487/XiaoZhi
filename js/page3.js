    ...
    function load(data) {
        ...
        data.forEach(function (item, index) {
            ...
            var $editBtn = $('<button class="edit-btn">修改</button>').click(function () {
                ...
                $ageSpan.hide();
                $colorSpan.hide();
                var $nameInput = $('<input type="text" value="' + item.title + '" placeholder="网站名称: ' + item.title + '">').show();
                var $ageInput = $('<input type="text" value="' + item.href + '" placeholder="网址: ' + item.href + '">').show();
                var $colorInput = $('<input type="text" value="' + item.img + '" placeholder="图片路径: ' + item.img + '">').show();
